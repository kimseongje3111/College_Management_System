...
public class Subject implements Serializable{
	...
	public String toString() {
		return "<SUBJECT>classIdNum : "+classIdNum+" subjectName : "+ subjectName+""
				+ " classNum : "+classNum+" classTime : "+classTime+" classRoom : "+
				classRoom+ " syllabus : "+syllabus+" availNum : "+availNum;
	}
